...
public class MainActivity extends AppCompatActivity {
    ...
    public void fetchData(View v) {
        showProgressDialog();
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET,"http://getmydiscounts.com/gmd/login/android/android/vendor/activitylog.php", new Response.Listener<JSONArray>() {
            @Override
